...
var title = createElement('h1', { id: 'title', className: 'header', style: style }, 'Murali prasanth');
...
render(React.createElement('div', { id: 'murali', style: style }, 'Murali Again'), document.getElementById('react-container1'));

// Renders this based on babel.js loaded above in script tag.
render(React.createElement(
    'div',
    { id: 'murali1', style: style },
    'Murali Again'
